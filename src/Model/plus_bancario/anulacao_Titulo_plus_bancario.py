...
def anulacao_titulo_plus_bancario(lancamento_antigo,lancameto_novo = None):
    print("INICIANDO PROCESSO DE ANULAÇAO DE TITULO")
    logging.info('INICIANDO PROCESSO DE ANULACAO DE TITIULO')
...
if __name__=='__main__':
    p.sleep(2)
    anulacao_titulo_plus_bancario('0539851')